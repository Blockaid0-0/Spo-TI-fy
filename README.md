ArTICL (Arduino TI Calculator Linking Library***REMOVED***
==============================================
TI Link Protocol library for the Arduino development platform

For more information and for questions, please refer to 
[this forum post](http://www.cemetech.net/forum/viewtopic.php?t=10809***REMOVED***
on Cemetech. An [introductory video](https://www.youtube.com/watch?v=-A14KrqVtt0***REMOVED***
contains a demo of the ControlLED example, and a
[how-to video](https://www.youtube.com/watch?v=gAUrIO3FTcQ***REMOVED*** created by
@geekboy1011 and @KermMartian shows you how to set up ArTICL with your calculator.

Using the Library
-----------------
If you want to be able to simply `send(***REMOVED***` and `get(***REMOVED***` packets to and from a
...
wire***REMOVED***, digital pin 3 = ring (white wire***REMOVED***, gnd = base (copper wire***REMOVED***. For the
...
The defaults are pin P5.7 = tip (red wire***REMOVED***, P5.6 = ring (white wire***REMOVED***, gnd = base
(copper wire***REMOVED***. In addition, connect a 1Kohm resistor from P5.6 to +3.3V, and from
P5.7 to +3.3V.

![MSP432 Launchpad to calculator connections](/doc/articl_msp432.png***REMOVED***
...
setup(***REMOVED*** function, assuming ticl is a TICL object or CBL2 object.
