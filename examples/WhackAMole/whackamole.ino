...
int onGetAsCBL2(uint8_t type, enum Endpoint model, int datalen***REMOVED*** {
  ...
  switch(list_len***REMOVED*** {
    ...
    case 4:{  // RGB Control structure
        ...
        int NewLed = (int***REMOVED***TIVar::realToFloat8x(&data[Offset], model***REMOVED***;  // Get element
        ...
        SetRgbActive(NewLed***REMOVED***;  //Turn on the new LED
        return 0;
    }    
