...
void CBL2::normalizeVariableHeader(const int model***REMOVED*** {
	...
	} else if (model == CALC82 && header_[2] == VarTypes82::VarReal && header_[3] == 0x5E /* tVarYVar */***REMOVED*** {
        header_[2] = VarTypes82::VarYVar;
    } else if (model == CALC82 && header_[2] == VarTypes82::VarReal && header_[3] == 0x60 /* tVarPic */***REMOVED*** {
